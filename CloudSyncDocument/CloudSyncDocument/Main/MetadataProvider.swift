...
extension Notification.Name {
    static let csdocMetadataDidChange = Notification.Name("csdocMetadataDidChange")
}
...
class MetadataProvider {
    ...
    init?(containerIdentifier: String?) {
        ...
        querySubscriber = Publishers.MergeMany(publishers).receive(on: DispatchQueue.main).sink { notification in
            ...
            NotificationCenter.default.post(name: .csdocMetadataDidChange, object: self, userInfo: userInfo)
        }
